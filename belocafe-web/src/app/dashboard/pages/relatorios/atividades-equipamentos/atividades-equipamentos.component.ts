...
@Component({
  selector: 'app-atividades-equipamentos',
  templateUrl: './atividades-equipamentos.component.html',
  styleUrls: ['./atividades-equipamentos.component.css'],
})
export class AtividadesEquipamentosComponent {
  // table configuration
  ...
  getFilterOptions(): void {
    this.equipamentoService.getAll().subscribe((data) => {
  ...
  onPaginateChange(event: PageEvent) {
    ...
    this.equipamento !== 0 ? this.getByFilter() : this.getAll();
  }
