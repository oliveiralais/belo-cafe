...
@Component({
  selector: 'app-new-calagem',
  templateUrl: './new-calagem.component.html',
  styleUrls: ['./new-calagem.component.css']
})
export class NewCalagemComponent {
  ...
  onSubmit(): void {
    if (this.calagemFormGroup.invalid) {
      ...
      this.calagemService.save(this.calagem).subscribe({
        next: () => {
