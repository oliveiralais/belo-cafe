...
@Component({
  selector: 'app-new-beneficiamento',
  templateUrl: './new-beneficiamento.component.html',
  styleUrls: ['./new-beneficiamento.component.css']
})
export class NewBeneficiamentoComponent {
  ...
  onSubmit(): void {
    if (this.beneficiamentoFormGroup.invalid) {
      ...
      this.beneficiamentoService.save(this.beneficiamento).subscribe({
        next: () => {
