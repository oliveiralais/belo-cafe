...
@Component({
  selector: 'app-new-irrigacao',
  templateUrl: './new-irrigacao.component.html',
  styleUrls: ['./new-irrigacao.component.css']
})
export class NewIrrigacaoComponent {
  ...
  onSubmit(): void {
    if (this.irrigacaoFormGroup.invalid) {
      ...
      this.irrigacaoService.save(this.irrigacao).subscribe({
        next: () => {
